...
def create_acds_str_small(batch_max_length, num_tokens,freeze):
    char_str =  CHARSTR(
        batch_max_length,freeze=freeze,img_size=(32,128),num_classes=num_tokens,patch_size=4, embed_dim=768, depth=6, num_heads=12, mlp_ratio=4, qkv_bias=True)
