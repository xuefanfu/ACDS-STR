...
def get_args(is_train=True):
    ...
    # freeze model parameter related to the generation of the character core areas 
    parser.add_argument('--freeze', action='store_true', help='freeze patial resnet')
    # close data aug
    parser.add_argument('--close_aug', action='store_true', help='close data aug')
    # is_mask_supervision 
    parser.add_argument('--is_mask_supervision', action='store_true', help='if need the supervision of the character core areas')
