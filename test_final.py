...
def benchmark_all_eval(model, criterion, converter, opt): #, calculate_infer_time=False):
    ...
    # # To easily compute the total accuracy of our paper.
        eval_data_list = ['IC131095','SVT', 'IIIT5k_3000', 'IC152077', 'SVTP', 'CUTE80']
        # eval_data_list = ['IC13_857', 'SVT', 'IIIT5k_3000', 'IC15_1811', 'SVTP', 'CUTE80']
        # eval_data_list = ['artistic', 'contextless', 'curve', 'incomplete_lmdb', 'incomplete_ori_lmdb',"multi_oriented","salient"]
    else:
        # The evaluation datasets, dataset order is same with Table 1 in our paper.
        eval_data_list = ['IIIT5k_3000', 'SVT', 
                          'IC131095',  'IC152077', 'SVTP', 'CUTE80']
...
def validation(model, criterion, evaluation_loader, converter, opt):
    ...
    for i, (image_tensors, labels, imgs_path) in enumerate(evaluation_loader):
        ...
        attens, char_preds = model(image, is_eval=True)[0:2] # final
